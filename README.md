# babel-plugin-styled-components-px2rem [![MIT](https://img.shields.io/github/license/hsuna/babel-plugin-styled-components-px2rem?style=plastic)](https://github.com/hsuna/babel-plugin-styled-components-px2rem/blob/master/LICENSE)

[![npm version](https://img.shields.io/npm/v/babel-plugin-styled-components-px2rem.svg?style=flat-square)](https://www.npmjs.com/package/babel-plugin-styled-components-px2rem) ![NPM Downloads](https://badgen.net/npm/dt/babel-plugin-styled-components-px2rem) [![Build Status](https://api.travis-ci.org/hsuna/babel-plugin-styled-components-px2rem.svg)](https://travis-ci.org/hsuna/babel-plugin-styled-components-px2rem) [![codecov](https://codecov.io/gh/hsuna/babel-plugin-styled-components-px2rem/branch/master/graph/badge.svg)](https://codecov.io/gh/hsuna/babel-plugin-styled-components-px2rem)
...
TypeScript transformer with similar functionality：[typescript-styled-components-px2rem](https://github.com/hsuna/typescript-styled-components-px2rem).
